  ...
  return (
    <div className="mx-auto max-w-[1300px] p-4">
      ...
      <div className="flex flex-wrap items-center gap-3 mb-4">
        ...
        <div className="flex flex-col sm:flex-row gap-6">
          <label className="text-sm">
            ...
            <div className="text-xs text-slate-500 dark:text-slate-400 mt-1">{loadedPairsName || "(demo loaded)"}</div>
          </label>
      ...
      <div className="rounded-lg border bg-white dark:bg-slate-900 overflow-hidden">
        <div className="flex justify-between items-center px-4 py-2 border-b bg-slate-50 dark:bg-slate-800">
      ...
      <div className="rounded-lg border bg-white dark:bg-slate-900 mt-6 overflow-hidden">
        <div className="flex justify-between items-center px-4 py-2 border-b bg-slate-50 dark:bg-slate-800">
