  ...
  return (
    <article>
      ...
      <section id="dataset">
        ...
        <ol>
          <li>
            Open a tool (e.g., <Link href="/globalmap">globalMAP</Link>) and
      ...
      <section id="globalmap">
        ...
        <ol>
          ...
          <li>
            ...
            <Link href="/pairmap">pairMAP</Link> or{" "}
      ...
      <section id="csmap">
        ...
        <ol>
          ...
          <li>
            ...
            follow up any pair in <Link href="/pairmap">pairMAP</Link>.
          </li>
        </ol>
        <p className="tip">
      ...
      <footer className="foot">
        ...
        <p>
          Explore: <Link href="/globalmap">globalMAP</Link> ·{" "}
