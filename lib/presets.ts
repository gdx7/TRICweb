...
export const PRESETS = {
  ...
  chimeras: [
    ...
    { label: "Structure — SA", url: "https://6xaweu7axahancgd.public.blob.vercel-storage.com/chimeras_SA_all.bed" },
    { label: "Chimeras — SS", url: "https://6xaweu7axahancgd.public.blob.vercel-storage.com/LR_chimeras_SS.bed" },
    { label: "Chimeras — MX", url: "https://6xaweu7axahancgd.public.blob.vercel-storage.com/LR_chimera_MX.bed" },
  ],
};
